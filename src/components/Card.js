...
export default function Card({recipe, setDrawer}) {
    return(
        <div className='tile'>
            <div style={{height:'300px', width:'300px', margin: '10px', display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor:'#ffffff', cursor: 'pointer'}}
                ...
                <div style={{height:'150px', width:'150px',borderRadius: '50%',
                    backgroundImage: `url(https://www.spoonacular.com/recipeImages/${recipe.image})`,
                    backgroundSize: 'cover', backgroundPosition: 'center', margin: '13px'}}/>
